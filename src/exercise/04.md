...
### I learned:
- How to use derived state to reduce state from falling out of sync with useEffect
- How to make use of useRef to track chages without causing rerenders
- Learned about lazy initializers
- Learned about custom hooks
- How to convert a class component style to functional component
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=04%3A%20useState%3A%20tic%20tac%20toe&em=ryanclott%40outlook.com).
